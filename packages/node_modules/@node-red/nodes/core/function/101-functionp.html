<script type="text/html" data-template-name="functionp">
    <style>
        .func-tabs-row {
            margin-bottom: 0;
        }
...
(function() {
    ...
    RED.nodes.registerType('functionp',{
        color:"#fdd0a2",
        category: 'functionp',
        defaults: {
        ...
        oneditprepare: function() {
            ...
            RED.library.create({
                url:"functionsp", // where to get the data from
                type:"functionp", // the type of object the library is for
