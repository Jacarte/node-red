...
module.exports = function(RED) {
    ...
    function FunctionNode(n) {
        ...
        var functionText = "var results = null;"+
            "results = (async function(msg,__send__,__done__){ "+
                ...
                "var node = {"+
                    ...
                    "done:__done__"+
                "};\n"+
                wasm_node.wasmwrap_code(node.func, {
                    cwd: __dirname,
                    non_cache: true,
                    // TODO make this an option of the node
                    // use_wizer: true,
                    // optimize: true
                })[0] +"\n"+
            "})(msg,__send__,__done__);";

        require('fs').writeFileSync("tmp.wrapper1.js", functionText);
        ...
        if (/node\.done\s*\(\s*\)/.test(functionText)) {
            ...
            acornWalk.simple(acorn.parse(functionText,{ecmaVersion: "latest"} ), {
                CallExpression(astNode) {
                    // TODO here add my Wasm wrapping function
        ...
        var sandbox = {
            ...
            GLOBAL_CACHE: wasm_node.GLOBAL_CACHE,
            start: function() {
                console.log("tming");
                START = process.hrtime()
            },
            
            // INSTANCE_CACHE: wasm_node.INSTANCE_CACHE,
            setTimeout: function () {
            ...
            try {
                ...
                if (node.ini && (node.ini !== "")) {
                    ...
                    (async function(__send__) {
                        ...
                        `+ wasm_node.wasmwrap_code(node.ini, {
                            cwd: __dirname,
                            non_cache: true,
                            // TODO make this an option of the node
                            // use_wizer: true,
                ...
                // Here, call the Wasm wrapping here
                ...
                if (node.fin && (node.fin !== "")) {
                    var finText = `(function () {
                        ...
                        `+wasm_node.wasmwrap_code(node.fin, {
                            cwd: __dirname,
                            non_cache: true,
                            // TODO make this an option of the node
                            // use_wizer: true,
                ...
                processMessage = function (msg, send, done) {
                    // console.log("Processing message", wasm_node.GLOBAL_CACHE);
                    ...
                    // Load the saved Wasm and call its init function
                    ...
                    context.results.then(function(results) {
                        ...
                        console.log("wasm duration: " + converted)
