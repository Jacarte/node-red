...
module.exports = {
    ...
    wasmwrap_code: function(node, ops = {}, api_permissions = {}, package_permissions = {}, file_permissions = {}) {
        ...
        let rendered_permissions= mustache.render(fs.readFileSync(permissions_template_path, 'utf-8'), {
            read_whites: file_permissions.READ.WHITELIST,
            read_blacks: file_permissions.READ.BLACKLIST,
            write_whites: file_permissions.WRITE.WHITELIST,
            write_blacks: file_permissions.WRITE.BLACKLIST,
        });
