...
// We implement here a basic permission layer
      ...
      "node_red_register": function(data, offset, length){
        ...
        function wrappernode(newnode){
           ...
           const instance = new WebAssembly.Instance(wasm, {
              ...
              ...get_context(RED, COMMAND_QUEUE, newnode, () => instance /**/, this, "instance")
            });
...
module.exports = function(RED){
    ...
    if(debug) console.log("Initializing context. Reading Global cache", RED.GLOBAL_CACHE);
    let [wasm, address] = RED.GLOBAL_CACHE["{{{ wasmfile }}}"];
    
    const wasi = getWasi();

    if(debug) console.log("Wasi loaded");
    ...
    if(debug) console.log("Instance created. Calling start to invoke the node registration");
