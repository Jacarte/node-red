...
class Writer{
    ...
    write(data, cb){
        let flag = this.options && this.options.flag? this.options.flag : 'w';
        console.log("write", chunk.length, this.offset, flag)
        let n = Node.FS.writeFileSync(this.path, data, this.offset, flag);
        this.written += n;
        this.offset += n;
        ...
        let flag = this.options && this.options.flag? this.options.flag : 'w';
        console.log("End",this.path, chunk.length, this.offset, flag)
        let n = Node.FS.writeFileSync(this.path, chunk, this.offset,  flag);
        this.written += n;
        this.offset += n;
